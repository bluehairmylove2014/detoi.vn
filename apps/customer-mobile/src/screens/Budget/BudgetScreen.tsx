...
import Accordion from '@presentational-mobile/atoms/Accordion';
import ClickableTag from '@presentational-mobile/atoms/ClickableTag';
import {
  Button,
  ListItem,
  ListItemSwitch,
  ...
  TextButton,
  TextInput,
} from '@presentational-mobile/atoms';
import StickersImage from '@presentational-mobile/atoms/StickersImage';
